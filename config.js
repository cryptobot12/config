module.exports = {
    ...
    "staking":{
        ...
        "checkTime": 30, // Check for new transaction in seconds
        ...
        "creditTime": 40, // Credit new transactions in seconds
        "creditCount":20, // How many transactions get credited to the users with one run
        "balanceDisplay": true, // Enable take balance display on8 balance command
        "minStake": 10, // Minimum value to stake
        "minUnstake": 10, // Minimum value to unstake
        "ownerPercentage": 50, // Bot owner percentage // Define how many percente users get from 100%
        "lockTime": 259200, // 24hours = 86400 - Lock time in seconds -> Check if the minimum time between payments and payouts as defined has been respected // Prevent stake pool hopping ;)
    ...
    "messages": { // Some messages contain markdown -> http://markdown.de
        ...
        "help": {
            ...
            "withdrawValue":"Withdraw balance to an address (0.01 EPG transaction fee will be added on top of the amount).",
